...
public class ArrecadacaoPrePagoDAO {

	public List<ArrecadacaoPrePago> getArrecadacaoPrePago(String primeiroDiaMesAnterior, String primeiroDiaMesAtual) {
		...
		try{
			...
			String query = " select ife.Val_item_fatura, ife.dta_prevista_credito, ife.cod_itemfatura_odin, ife.cod_conta_contabil, " +
							" ife.cod_sku_odin, ife.nom_modalidade_pagto, ife.num_contrato, ife.val_iss, "+
							...
							"  where nom_modalidade_pagto = 'PRE-PAGO'  " + //preencher conforme informação sendo tratada
			...
			List<ArrecadacaoPrePago> arrecadacoesPrePago = new ArrayList<ArrecadacaoPrePago>();
			
			while(resultSet.next()){
				
				ArrecadacaoPrePago arrecadacao = new ArrecadacaoPrePago();
				...
				arrecadacao.setCodContaContabil(resultSet.getString("cod_conta_contabil"));
				...
				arrecadacao.setModalidadePagto(resultSet.getString("nom_modalidade_pagto"));
				arrecadacao.setNumContrato(resultSet.getString("num_contrato"));
				arrecadacao.setValISS(resultSet.getString("val_iss"));
			
				arrecadacoesPrePago.add(arrecadacao);
			}
