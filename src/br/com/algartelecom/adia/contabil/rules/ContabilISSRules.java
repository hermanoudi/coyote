...
public class ContabilISSRules extends AbstractContabilFaturamentoRules {

	public ContabilISSRules(FaturaImpostos faturaImpostos, String creditoOuDebito) throws Exception {
	...
	private void montaAtributosCredito(FaturaImpostos faturaImpostos) {
		...
		super.DescricaoLinhaLancamento = "ISS Credito POS-PAGO Elastic Cloud " + FormataData.getMesAnoAnteriorEmExtensoComPrimeiraLetraMaiuscula();	
	}
	...
	private void montaAtributosDebito(FaturaImpostos faturaImpostos) throws Exception {
		...
		super.DescricaoLinhaLancamento = "ISS Debito POS-PAGO Elastic Cloud " + FormataData.getMesAnoAnteriorEmExtensoComPrimeiraLetraMaiuscula();
	}
