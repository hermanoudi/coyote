...
public class ContabilCofinsRulesPrePago extends AbstractContabilFaturamentoRules {

	public ContabilCofinsRulesPrePago(FaturasPrePago faturaImpostos, String creditoOuDebito) throws Exception {
	...
	private void montaAtributosCredito(FaturasPrePago faturaImpostos) {
		...
		super.contaContabil = ContaContabilEnum.ELASTIC_IMPOSTO_COFINS_CREDITO_PRE_PAGO.getCodigo();
		super.regulamento = "000";
		super.centroResultado = "000000000"; 
		super.produto = "000000000000";
		super.uf = "00";
		super.valorDebito = "0,00"; 
		super.valorCredito = FormataValores.substituiSeparadorDecimalPontoPorVirgula(faturaImpostos.getValorCofins());
		...
		super.DescricaoLinhaLancamento = "COFINS Credito_PRE-PAGO Elastic Cloud " + FormataData.getMesAnoAnteriorEmExtensoComPrimeiraLetraMaiuscula();
	}

	private void montaAtributosDebito(FaturasPrePago faturaImpostos) throws Exception {
		
		super.contaContabil = ContaContabilEnum.ELASTIC_IMPOSTO_COFINS_DEBITO_PRE_PAGO.getCodigo();
		...
		super.uf = "MG";
		super.valorDebito = FormataValores.substituiSeparadorDecimalPontoPorVirgula(faturaImpostos.getValorCofins());
		...
		super.DescricaoLinhaLancamento = "COFINS Debito_PRE-PAGO Elastic Cloud " + FormataData.getMesAnoAnteriorEmExtensoComPrimeiraLetraMaiuscula();
	}
