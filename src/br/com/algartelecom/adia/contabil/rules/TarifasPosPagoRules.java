...
public class TarifasPosPagoRules extends AbstractContabilFaturamentoRules {
	
	public TarifasPosPagoRules(Tarifa tarifa, String creditoOuDebito) throws Exception {
	...
	private void montaAtributosCredito(Tarifa tarifa) throws Exception {
		...
		super.contaContabil = ContaContabilEnum.ELASTIC_TARIFA_POS_CREDITO.getCodigo();
		...
		super.codigoRastreamentoLote =  FormataData.getMesAnoAnteriorEmExtensoComPrimeiraLetraMaiuscula() + "_Credito_POS-PAGO_Tarifa_" + super.contaContabil + "_" + tarifa.getCodSKUOdin() + "_" +  tarifa.getCodItemFaturaOdin();
		super.DescricaoLinhaLancamento = "TARIFA C/C Credito POS-PAGO Elastic Cloud " + FormataData.getMesAnoAnteriorEmExtensoComPrimeiraLetraMaiuscula();	
	}

	private void montaAtributosDebito(Tarifa tarifa) throws Exception {
		
		super.contaContabil = ContaContabilEnum.ELASTIC_TARIFA_POS_DEBITO.getCodigo();
		super.regulamento = "001";
		super.centroResultado = MontaCamposArquivosPosicionais.preencherCampo(CentroDeResultado.substituiCREmBrancoPorCRdeUberlandia(tarifa.getCodCentroCusto()), 9, true); 
		...
		super.codigoRastreamentoLote =  FormataData.getMesAnoAnteriorEmExtensoComPrimeiraLetraMaiuscula() + "_Debito_POS-PAGO_Tarifa_" + super.contaContabil + "_" + tarifa.getCodSKUOdin() + "_" + tarifa.getCodItemFaturaOdin();
		super.DescricaoLinhaLancamento = "TARIFA C/C Debito_POS-PAGO Elastic Cloud " + FormataData.getMesAnoAnteriorEmExtensoComPrimeiraLetraMaiuscula();
	}
