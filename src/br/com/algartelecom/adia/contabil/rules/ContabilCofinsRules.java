...
public class ContabilCofinsRules extends AbstractContabilFaturamentoRules {

	public ContabilCofinsRules(FaturaImpostos faturaImpostos, String creditoOuDebito) throws Exception {
	...
	private void montaAtributosCredito(FaturaImpostos faturaImpostos) {
		...
		super.contaContabil = ContaContabilEnum.ELASTIC_IMPOSTO_COFINS_CREDITO.getCodigo();
		super.regulamento = "000";
		super.centroResultado = "000000000"; 
		super.produto = "000000000000";
		super.uf = "00";
		super.valorDebito = "0,00"; 
		super.valorCredito = FormataValores.substituiSeparadorDecimalPontoPorVirgula(faturaImpostos.getValCofins());
		...
		super.DescricaoLinhaLancamento = "COFINS Credito POS-PAGO Elastic Cloud " + FormataData.getMesAnoAnteriorEmExtensoComPrimeiraLetraMaiuscula();
	
	}

	private void montaAtributosDebito(FaturaImpostos faturaImpostos) throws Exception {
		
		super.contaContabil = ContaContabilEnum.ELASTIC_IMPOSTO_COFINS_DEBITO.getCodigo();
		...
		super.uf = "MG";
		super.valorDebito = FormataValores.substituiSeparadorDecimalPontoPorVirgula(faturaImpostos.getValCofins());
		...
		super.DescricaoLinhaLancamento = "COFINS Debito POS-PAGO Elastic Cloud " + FormataData.getMesAnoAnteriorEmExtensoComPrimeiraLetraMaiuscula();
	}
